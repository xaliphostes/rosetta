...
// ============================================================================
// Auto array registration - Internal helpers
// ============================================================================
    ...
    inline std::any jsToArray(const Napi::Value& js_val)
    {
        ...
        if (js_arr.Length() != N) {
            throw Napi::TypeError::New(js_val.Env(), 
                "Expected array of length " + std::to_string(N) + 
                ", got " + std::to_string(js_arr.Length()));
        }
...
inline void registerArrayType(JsGenerator& generator)
{
    ...
    generator.register_type_converter(
        typeName,
        detail::arrayToJs<ArrayType, T, N>,
        detail::jsToArray<ArrayType, T, N>
    );
}
...
inline void registerArrayAlias(JsGenerator& generator)
{
    ...
    generator.register_type_converter(
        aliasName,
        detail::arrayToJs<AliasType, ElementType, N>,
