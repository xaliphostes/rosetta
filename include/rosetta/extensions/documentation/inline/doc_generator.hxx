namespace rosetta::extensions {
    ...
    inline DocGenerator::DocGenerator(DocFormat format) : format_(format) {
    }

    inline std::string DocGenerator::generate() const {
        std::stringstream ss;
    ...
    inline std::string DocGenerator::generate_class_doc(const std::string &class_name) const {
        std::stringstream ss;
    ...
    inline void DocGenerator::generate_markdown(std::stringstream &ss) const {
    ...
    inline void
    DocGenerator::generate_class_markdown(std::stringstream &ss, const std::string &class_name,
    ...
    inline void DocGenerator::generate_html(std::stringstream &ss) const {
        ss << "<!DOCTYPE html>\n";
        ss << "<html>\n<head>\n";
    ...
    inline void
    DocGenerator::generate_class_html(std::stringstream &ss, const std::string &class_name,
                                      const core::Registry::MetadataHolder &holder) const {
        const auto &inheritance = holder.get_inheritance();
    ...
    inline void DocGenerator::generate_plaintext(std::stringstream &ss) const {
        ss << "API DOCUMENTATION\n";
        ss << "=================\n\n";
        ss << "Auto-generated by Rosetta\n\n";
    ...
    inline void
    DocGenerator::generate_class_plaintext(std::stringstream &ss, const std::string &class_name,
                                           const core::Registry::MetadataHolder &holder) const {
        const auto &inheritance = holder.get_inheritance();
    ...
    inline std::string DocGenerator::to_anchor(const std::string &str) {
        std::string result;
        for (char c : str) {
            if (std::isalnum(c)) {
