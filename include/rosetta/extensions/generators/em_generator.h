...
namespace rosetta::em_gen {
    ...
    struct ClassWrapper {
        ...
        static em::val callMethod(T& obj, const std::string& name, em::val args) {
            ...
            try {
                ...
                bool name_in_methods = std::find(methods.begin(), methods.end(), name) != methods.end();
    ...
    public:
        static void bind(const std::string &js_name) {
            ...
            InheritanceRegistry::instance().register_class(name, std::type_index(typeid(T)), {base_name});
                ...
                switch (arity) {
                    case 0:
                        em_class.function(method_name.c_str(),
                            std::function<em::val(T&)>(
                                [method_idx](T& obj) -> em::val {
                    ...
                    case 3:
                        em_class.function(method_name.c_str(),
                            std::function<em::val(T&, em::val, em::val, em::val)>(
                                [method_idx](T& obj, em::val arg0, em::val arg1, em::val arg2) -> em::val {
                                    const std::string& mname = getMethodNameStorage()[method_idx];
                                    em::val args = em::val::array();
                                    args.call<void>("push", arg0);
                                    args.call<void>("push", arg1);
                    ...
                    case 4:
                        em_class.function(method_name.c_str(),
                            std::function<em::val(T&, em::val, em::val, em::val, em::val)>(
                                [method_idx](T& obj, em::val arg0, em::val arg1, em::val arg2, em::val arg3) -> em::val {
                                    const std::string& mname = getMethodNameStorage()[method_idx];
                                    em::val args = em::val::array();
                                    args.call<void>("push", arg0);
                                    args.call<void>("push", arg1);
                    ...
                    case 5:
                        em_class.function(method_name.c_str(),
                            std::function<em::val(T&, em::val, em::val, em::val, em::val, em::val)>(
                                [method_idx](T& obj, em::val a0, em::val a1, em::val a2, em::val a3, em::val a4) -> em::val {
                                    const std::string& mname = getMethodNameStorage()[method_idx];
                                    em::val args = em::val::array();
