...
namespace rosetta {
    ...
    struct EnumValueInfo {
        ...
        EnumValueInfo(const std::string& n, int64_t v) 
            : name(n), value(v) {}
    };
    ...
    public:
        ...
        explicit EnumInfo(const std::string& enum_name) 
            : name(enum_name) {}
        ...
        std::string getName(int64_t value) const {
            ...
            throw std::runtime_error("Enum value " + std::to_string(value) + " not found in enum '" + name + "'");
        }
    };
    ...
    public:
        ...
        void registerEnum(const std::string& enum_name);
...
#define ENUM_VALUE(ValueName)                                                 \
                reg.value(#ValueName, EnumType_t::ValueName);
...
#define PLAIN_ENUM_VALUE(ValueName)                                           \
                reg.value(#ValueName, ValueName);
 ...
 */
#define ROSETTA_ENUM_VALUE_IMPL(EnumType, ValueName) \
    reg.value(#ValueName, EnumType::ValueName);
