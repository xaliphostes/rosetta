...
namespace rosetta {
    ...
    namespace gen_detail {
        ...
        constexpr std::string_view CMAKE_HEADER = R"CMK(# Generated by rosetta::generate — do not edit by hand.
...
if(NOT CMAKE_CXX_COMPILER)
    ...
    set(CMAKE_CXX_COMPILER "${CLANG_P2996_ROOT}/bin/clang++")
        ...
        constexpr std::string_view PY_CPP = R"CPP(// Generated by rosetta::generate — do not edit by hand.
#include "{{HEADER}}"
...
add_custom_command(TARGET {{LIB}} POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy
        ...
        constexpr std::string_view NODE_CPP = R"CPP(// Generated by rosetta::generate — do not edit by hand.
#include "{{HEADER}}"
...
add_custom_command(TARGET {{LIB}} POST_BUILD
  ...
  "devDependencies": {
    ...
    "node-addon-api": "^8.0.0"
        ...
        constexpr std::string_view REST_CPP = R"CPP(// Generated by rosetta::generate — do not edit by hand.
#include "{{HEADER}}"
...
target_link_options({{LIB}} PRIVATE
    ...
    -lc++ -lc++abi)
        ...
        constexpr std::string_view WEB_CPP = R"CPP(// Generated by rosetta::generate — do not edit by hand.
#include "{{HEADER}}"
...
EMSCRIPTEN_BINDINGS({{LIB}}) {
    rosetta::bind_emscripten<{{CLASS}}>("{{CLASS}}");
        ...
        constexpr std::string_view WEB_CMAKE = R"CMK(# Generated by rosetta::generate — do not edit by hand.
cmake_minimum_required(VERSION 3.28)
project({{LIB}}_binding CXX)
...
#define ROSETTA_GEN_VARS(c)                                                                        \
    ...
    template <typename T> void generate(const GenerateOptions &opt) {
        ...
        constexpr const char *class_name = std::define_static_string(
