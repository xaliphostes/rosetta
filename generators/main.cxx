...
// }
//
// Output structure (when all targets enabled):
//   <output_base_dir>/
//   â”œâ”€â”€ python/
...
void print_usage(const char* program_name) {
    ...
    std::cout << "  include paths, and which targets to generate (python/wasm/javascript).\n";
    std::cout << "\n";
    std::cout << "Examples:\n";
    std::cout << "  " << program_name << " project.json\n";
    std::cout << "  " << program_name << " --init myproject.json\n";
    std::cout << "\n";
    std::cout << "For more information, see the README.md\n";
}
